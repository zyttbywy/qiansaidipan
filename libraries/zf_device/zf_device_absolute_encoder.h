...
#define ABSOLUTE_ENCODER_CS_PIN             (P00_8)                            // CS引脚定义
...
//=================================================声明 角度传感器 基础函数================================================
int16   absolute_encoder_get_location       (void);                             // 绝对值编码器获取当前角度值
int16   absolute_encoder_get_offset         (void);                             // 绝对值编码器获取相较上次位置的偏移值
uint8   absolute_encoder_init               (void);                             // 绝对值编码器初始化
//=================================================声明 角度传感器 基础函数================================================
#endif
